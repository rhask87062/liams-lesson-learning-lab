...
import { CursorGradient } from './ui/cursor-gradient.jsx';
...
const MagicPaint = ({ onHome, onLock, isNavigationLocked }) => {
  ...
  useEffect(() => {
    ...
    const isCanvasEffect = !['splashCursor', 'gradientTrail'].includes(currentEffect);
  ...
  const isComponentEffect = ['splashCursor', 'gradientTrail'].includes(currentEffect);
